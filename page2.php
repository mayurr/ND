...
<script type="text/javascript">var userId = "<?php echo $userId; ?>";var flag = "<?php echo $flag; ?>";var giveId = "<?php echo $giveId; ?>";var objectId = "<?php echo $objectId; ?>";var sessionUserId = "<?php echo $_SESSION['user1']['userId']; ?>";var applicantsArray = "<?php echo $_SESSION['applicants'];?>";var givesArray = "<?php echo $_SESSION['gives'];?>";</script>
...
<div id="mainContainer">
	...
	<div id="leftContainer">
		...
		<div id="leftContainerContents">
	     	<div id="nameDiv">
	     		<input type="text" id="objectName" size="30" onblur="javascript: if(this.value=='') { this.value='Give Name';this.className='blur'}"
                onfocus="javascript: 					if(this.value=='Give Name') {this.value='';this.className='focus'};" value="Give Name"/>
	     	</div>
	     	 <div id="Location"  >
	    	...
	    	<button id="submit" onclick="giveData();" name="giveSubmit">Add Give</button>
	   	</div>
	...
	<div id="rightContainer">
		...
		if($_SESSION['userGives'][0]['giveId'] != "empty"){
			echo "<table id='giveList'>";
			for($i=0;$i<sizeof($_SESSION['userGives']);$i++){		
				echo "<tr class='giveRow'>";
				echo    "<td id=giveRow".$_SESSION['userGives'][$i]['giveId']." onmouseover='addBorder(this.id);' onmouseout='removeBorder(this.id);' onclick='showApplicants(this.id);'>";
				echo    "<table>";
				echo   		"<tr><td><table><tr>";
				echo   			"<td width=150 height=100 align=center><img class='giveListImage' width=100 height=100 src=uploads/".$_SESSION['userGives'][$i]['objectImage']." /></td>";
				echo   			"<td width=300 height=100 align=left><p class='giveListDescription'>".$_SESSION['userGives'][$i]['objectDescription']."</p></td>";
				echo   		"</tr></table></td></tr>";
				echo   		"<tr><td><table><tr>";
				echo   			"<td width=150 height=10 align=center><p class='giveListName'>".$_SESSION['userGives'][$i]['objectName']."</p></td>";
				echo   			"<td width=150 height=10 align=left><p class='giveListStartDate'>Start: ".$_SESSION['userGives'][$i]['startDate']."</p></td>";
				echo   			"<td width=150 height=10 align=left><p class='giveListEndDate'>End: ".$_SESSION['userGives'][$i]['endDate']."</p></td>";
				echo   		"</tr></table></td></tr>";
				echo    "</table>";
				echo    "</td>";
				echo "</tr>";
	...
	<div id="leftContainer">
		...
		<div id="leftContainerContentsAlt">
			...
			<div id="right_col">
    			<div id="upload_area">
    				<img id="giveImage" height="190" width="190"/>
    			</div>
    		</div>
	   		<div id="description">
	...
	<?php
		if($_SESSION['gives'][0]['giveId'] != "empty"){
			...
			for($i=0;$i<sizeof($_SESSION['gives']);$i++){
				if ($_SESSION['gives'][$i]['userId'] == $userId) {	
					$className = "giveRow";
					if($_SESSION['gives'][$i]['giveId'] == $giveId) {
						$className .= "ClickBorder";
					} 
					echo "<tr class='".$className."'>";
					echo    "<td id=giveRow".$_SESSION['gives'][$i]['giveId']." onmouseover='addBorder(this.id);' onmouseout='removeBorder(this.id);' onclick='showApplicants(this.id);'>";
					echo    "<table>";
					echo   		"<tr><td><table><tr>";
					echo   			"<td width=150 height=100 align=center><img class='giveListImage' width=100 height=100 src=uploads/".$_SESSION['gives'][$i]['objectImage']." /></td>";
					echo   			"<td width=300 height=100 align=left><p class='giveListDescription'>".$_SESSION['gives'][$i]['objectDescription']."</p></td>";
					echo   		"</tr></table></td></tr>";
					echo   		"<tr><td><table><tr>";
					echo   			"<td width=150 height=10 align=center><p class='giveListName'>".$_SESSION['gives'][$i]['objectName']."</p></td>";
					echo   			"<td width=150 height=10 align=left><p class='giveListStartDate'>Start: ".$_SESSION['gives'][$i]['startDate']."</p></td>";
					echo   			"<td width=150 height=10 align=left><p class='giveListEndDate'>End: ".$_SESSION['gives'][$i]['endDate']."</p></td>";
					echo   		"</tr></table></td></tr>";
					echo    "</table>";
					echo    "</td>";
					echo "</tr>";
